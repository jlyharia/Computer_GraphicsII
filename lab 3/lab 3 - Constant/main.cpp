/**
    ...
    Lab 3   : Shading and Illumination Modeling  - Constant Shading
    Student : YiHung Lee
    GW id   : G42957795
**/
...
//    model_1.setShiftLocal(0,0,-2);
    ...
    SCANLINE scan_1(model_1.vec_frontface_poly, model_1.vec_device_vertex,
                    model_1.vec_world_vertex);
    //delcare scan line 1, send world coordinate to SCANLINE
    scan_1.setDeviceCoord(Xmin, Xmax, Ymin, Ymax);
    scan_1.pixelCompute();

    real_pixel = scan_1.real_pixel;
    //put pixel value to real_pixel
    ...
    glutCreateWindow ("Constant Shading"); 	//create windows
	//----------------------------step 1 end-----------------------------------
