/**
    ...
    Lab 3   : Shading and Illumination Modeling  - Phong Shading
    Student : YiHung Lee
    GW id   : G42957795
**/
...
void iniModel()
{
    ...
    loadModel model_1;
//    float offset[3] = {-2,1,-5};
//    model_1.setfileName("cow.d");
//    model_1.setShiftLocal(offset);

    float offset[3] = {0,0,-1.5};
...
//    float offset[3] = {0,1,-50};
//    model_1.setfileName("plane.d");
//    model_1.setShiftLocal(offset);
    ...
    SCANLINE scan_1(model_1.vec_frontface_poly, model_1.vec_polygon,
                    ...
                    model_1.M_Invert);
    //delcare scan line 1
//    scan_1.setImage("WoodFine0017_S.bmp");
    scan_1.setImage("Flames_512.bmp");
//    scan_1.setImage("Flames_256.bmp");
//    scan_1.setImage("Checkerboard.bmp");
//    scan_1.setImage("tungurahua_taschler_512.bmp");

    scan_1.setObjectCenter(offset);
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow ("CG 2 Lab 4 - Texture Mappings"); 	//create windows
	//----------------------------step 1 end-----------------------------------
